...
const skills = [
  { name: "React", level: 95, x: 20, y: 30, color: "#61DAFB" },
  { name: "TypeScript", level: 90, x: 70, y: 20, color: "#3178C6" },
  { name: "Next.js", level: 88, x: 50, y: 60, color: "#000000" },
  { name: "Node.js", level: 85, x: 80, y: 70, color: "#339933" },
  { name: "Python", level: 82, x: 15, y: 80, color: "#3776AB" },
  { name: "GSAP", level: 78, x: 85, y: 40, color: "#88CE02" },
  { name: "Three.js", level: 75, x: 40, y: 25, color: "#000000" },
  { name: "PostgreSQL", level: 80, x: 60, y: 85, color: "#336791" },
  { name: "Docker", level: 70, x: 25, y: 50, color: "#2496ED" },
  { name: "AWS", level: 72, x: 75, y: 55, color: "#FF9900" },
]
          ...
          {skills.map((skill, index) => (
            ...
            >
              <div className="relative">
                <div
                  className="w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 group-hover:scale-125 group-hover:shadow-2xl"
