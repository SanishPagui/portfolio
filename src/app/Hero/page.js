  ...
  return (
    <div className='w-full h-screen'>
        ...
        <div className='pt-32 font-[Teko]'>
          <div className=' w-full h-[500] flex items-strech justify-start'>
          ...
          <div className='w-full h-[530] '>
            <div className='pl-[480px] flex justify-center tracking-tighter leading-none -space-x-5'>
